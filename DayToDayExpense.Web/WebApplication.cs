...
namespace DayToDayExpense.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class DayToDayExpenseAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private DayToDayExpense.Module.DayToDayExpenseModule module3;
        private DayToDayExpense.Module.Web.DayToDayExpenseAspNetModule module4;
        ...
        static DayToDayExpenseAspNetApplication() {
        ...
        #endregion
        public DayToDayExpenseAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void DayToDayExpenseAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new DayToDayExpense.Module.DayToDayExpenseModule();
            this.module4 = new DayToDayExpense.Module.Web.DayToDayExpenseAspNetModule();
            ...
            // 
            // DayToDayExpenseAspNetApplication
            // 
            this.ApplicationName = "DayToDayExpense";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.DayToDayExpenseAspNetApplication_DatabaseVersionMismatch);
